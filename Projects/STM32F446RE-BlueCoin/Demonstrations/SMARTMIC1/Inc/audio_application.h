...
#define AUDIO_OUT_DEVICE PCM1774_0
#define AUDIO_OUT_INTERRUPT AUDIO_SAIx_DMAx_IRQ


//#define BLUECOIN_1720   /*Uncomment to configure mic distance for '1720' signed BlueCoin*/
